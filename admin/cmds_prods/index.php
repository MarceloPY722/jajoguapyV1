  ...
  <div class="main-content">
    ...
    <div class="row">
      ...
      <table class="table table-bordered datatable" id="table-3">
        ...
        <tbody>
          <?php
					$req =  $bd->query("SELECT c.* ,p.libelle,p.prix_vente,p.image,u.user FROM
          ...
          <tr class="gradeA">
            ...
            <td><?= $data['qte'] ?></td>
            <td>
              <a href="/Jajoguapyv2/admin/cmds_prods/update.php?id=<?= $data['id'] ?>"
                class="btn btn-default btn-sm btn-icon icon-left">
                <i class="entypo-pencil"></i>
                Editar
              </a>

              <a href="/Jajoguapyv2/admin/cmds_prods/delete.php?id=<?= $data['id'] ?>"
