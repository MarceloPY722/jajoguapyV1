...
if(isset($_POST['submit'])){
    ...
    header('location: /Jajoguapyv2/admin/user/index.php?msg=updated');
}
?>
        ...
        <div class="card-body">
          ...
          <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input value="<?= $data['user'] ?>" type="text" name="user" id="user" class="form-control" placeholder="Usuario"
            ...
            <div class="form-group">
              ...
              <select name="role" id="role" class="form-control" placeholder="" aria-describedby="role">
                ...
                <option <?= ($data['role'] == "cliente")?'selected':''?> value="cliente">Cliente</option>
              </select>
            </div>
            <div class="form-group">
